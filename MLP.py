...
xls_file = pd.ExcelFile('F:\IRIS_data_try2.xlsx')
#xls_file
...
#   epoch_w8[:,:,loop] = hidden_to_output
#   epoch_wt[:,:,loop] = input_to_hidden
    
   print("epoch",(loop+1)," complete\n")
...
for i in range(test_dimension):
      ...
      if(test_final[i] <=0.33 and test_desired_op[i] <= 0.33):
        ...
        miss = miss + 1
print('total no of samples= ',test_dimension)
print('No. of correct classification = ',correct)          
print('No. of miss classification = ',miss)
print('Percentage of of correct classification = ',correct/test_dimension*100)   
